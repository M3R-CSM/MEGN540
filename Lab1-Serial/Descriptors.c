                ...
                .CDC_ManagementEndpoint =
                        {
                                ...
                                .EndpointAddress        = (ENDPOINT_DIR_IN | CDC_NOTIFICATION_EPADDR),
                ...
                .CDC_DataOutEndpoint =
                        {
                                ...
                                .EndpointAddress        = (ENDPOINT_DIR_OUT | CDC_RX_EPADDR),
                ...
                .CDC_DataInEndpoint =
                        {
                                ...
                                .EndpointAddress        = (ENDPOINT_DIR_IN | CDC_TX_EPADDR),
                                .Attributes             = (EP_TYPE_BULK | ENDPOINT_ATTR_NO_SYNC | ENDPOINT_USAGE_DATA),
                                .EndpointSize           = CDC_TXRX_EPSIZE,
                                .PollingIntervalMS      = 0x01
                        }
...
const USB_Descriptor_String_t ProductString =
	...
	.UnicodeString = L"Pololu A-Star 32U4 Bootloader"
                ...
                .UnicodeString = L"MEGN540 Zumo Project Car"
#endif
        };
